...
plot_histogram(x_neumann, data_hist_neumann, k_neumann, interval_gauss, "Распределение Релея", 3, d=d_rayleigh)
plot_polygon(x_neumann, data_polygon_neumann, kp_neumann, interval_gauss, "Распределение Релея", 3, d=d_rayleigh)